...
class ControllerExceptionHandlerTest {
    private static final String ADMIN_V1_WS_PACKAGE = "com.doccms.adapter.ws.admin.v1";
    ...
    void adminControllerExceptionHandlerShouldHandleAllAdminControllerExceptions() {
        var internalControllerExceptions = findAllExceptionClassesInPackage(ADMIN_V1_WS_PACKAGE);
